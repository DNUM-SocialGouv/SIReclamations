...
public class ReferentielDeCategorieDEtablissementCsvAdapter
  ...
  @Override
  public List<String> recupererAutoritesCompetentesParCodeSousCategorieEtablissement(
      int codeSousCategorieEtablissement) {
    return autoritesCompetentesParCodeCategorieEtablissement.getOrDefault(
        codeSousCategorieEtablissement, Collections.emptyList());
  }
}
