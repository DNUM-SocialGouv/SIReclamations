...
public class ReclamationAdapter implements ReclamationPort {
    ...
    public void deposerReclamation(DossierReclamation dossierReclamation) {
        var autoriteCompetente = categorieEtablissementRepository.recupererAutoriteCompetenteParCodeSousCategorieEtablissement(dossierReclamation.getCodeSousCategorieEtablissement());
